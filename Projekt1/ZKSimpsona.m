...
s1 = ZKSimpsonaY(@fBiegunowa, a, c, d, m);
s2 = ZKSimpsonaY(@fBiegunowa, b, c, d, m);

s3 = 0;
for i = 1:1:(n - 1)
    s3 = s3 +  ZKSimpsonaY(@fBiegunowa, a + i*h1, c, d, m);
end

s4 = 0;
for i = 0:1:(n - 1)
    s4 = s4 +  ZKSimpsonaY(@fBiegunowa, a + i*h1 + 0.5*h1, c, d, m);
end
